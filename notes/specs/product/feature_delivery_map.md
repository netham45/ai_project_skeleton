...
| --- | --- | --- | --- | --- | --- |
| F01 | bootstrap governance starter | none | Establish the governing surfaces and bounded checks first. | `python3 -m pytest tests/unit/test_lifecycle_docs.py -q` | planned |
...
| F03 | product-definition contract package | F02 | Deliver flow inventory, contract notes, domain model, operator surfaces, and implementation slicing before setup. | `python3 -m pytest tests/unit/test_lifecycle_docs.py -q` | planned |
